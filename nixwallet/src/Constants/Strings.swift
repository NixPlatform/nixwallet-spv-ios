...
enum S {
    ...
    enum Symbols {
        ...
        static func currencyButtonTitle(maxDigits: Int) -> String {
            ...
            case 8:
                return "NIX\(S.Symbols.narrowSpace)(\(S.Symbols.ltc))"
            default:
                return "milli NIX\(S.Symbols.narrowSpace)(\(S.Symbols.lites))"
            }
        }
    ...
    enum Scanner {
        static let flashButtonLabel = NSLocalizedString("Scanner.flashButtonLabel", value:"Camera Flash", comment: "Scan NIX address camera flash toggle")
    }
    ...
    enum Send {
        ...
        static let cameraUnavailableTitle = NSLocalizedString("Send.cameraUnavailableTitle", value:"NixWallet is not allowed to access the camera", comment: "Camera not allowed alert title")
        ...
        enum UsedAddress {
            ...
            static let firstLine = NSLocalizedString("Send.UsedAddress.firstLine", value: "NIX addresses are intended for single use only.", comment: "Adress already used alert message - first part")
    ...
    enum JailbreakWarnings {
        ...
        static let messageWithBalance = NSLocalizedString("JailbreakWarnings.messageWithBalance", value:"DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access NixWallet's keychain data and steal your NIX! Wipe this wallet immediately and restore on a secure device.", comment: "Jailbreak warning message")
        static let messageWithoutBalance = NSLocalizedString("JailbreakWarnings.messageWithoutBalance", value:"DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access NixWallet's keychain data and steal your NIX. Please only use NixWallet on a non-jailbroken device.", comment: "Jailbreak warning message")
    ...
    enum UnlockScreen {
        ...
        static let touchIdPrompt = NSLocalizedString("UnlockScreen.touchIdPrompt", value:"Unlock your NixWallet.", comment: "TouchID/FaceID prompt text")
    ...
    enum TransactionDetails {
        ...
        static let txHashHeader = NSLocalizedString("TransactionDetails.txHashHeader", value:"NIX Transaction ID", comment: "Transaction ID header")
    ...
    enum BuyCenter {
      ...
      enum Cells {
        ...
        static let coinbaseFinancialDetails = NSLocalizedString("BuyCenter.coinbaseFinancialDetails", value: "• Buy NIX\n• Available in 33 countries\n• Trade and Store your NIX\n• Easy for cryptocurrency novices", comment: "Coinbase buy financial details")
      }
    }
    ...
    enum SecurityCenter {
        ...
        enum Cells {
            ...
            static let pinDescription = NSLocalizedString("SecurityCenter.pinDescription", value:"Protects your NixWallet from unauthorized users.", comment: "PIN button description")
            static let touchIdTitle = NSLocalizedString("SecurityCenter.touchIdTitle", value:"Touch ID", comment: "Touch ID button title")
            static let touchIdDescription = NSLocalizedString("SecurityCenter.touchIdDescription", value:"Conveniently unlock your NixWallet and send money up to a set limit.", comment: "Touch ID/FaceID button description")
            static let paperKeyTitle = NSLocalizedString("SecurityCenter.paperKeyTitle", value:"Paper Key", comment: "Paper Key button title")
            static let paperKeyDescription = NSLocalizedString("SecurityCenter.paperKeyDescription", value:"The only way to access your NIX if you lose or upgrade your phone.", comment: "Paper Key button description")
    ...
    enum UpdatePin {
        ...
        static let createInstruction = NSLocalizedString("UpdatePin.createInstruction", value:"Your PIN will be used to unlock your NixWallet and send money.", comment: "PIN creation info.")
        ...
        static let caption = NSLocalizedString("UpdatePin.caption", value:"Remember this PIN. If you forget it, you won't be able to access your NIX.", comment: "Update PIN caption text")
    ...
    enum RecoverWallet {
        ...
        static let intro = NSLocalizedString("RecoverWallet.intro", value:"Recover your NixWallet with your paper key.", comment: "Recover wallet intro")
    ...
    enum AccountHeader {
        static let defaultWalletName = NSLocalizedString("AccountHeader.defaultWalletName", value:"My NixWallet", comment: "Default wallet name")
    ...
    enum TouchIdSettings {
        ...
        static let label = NSLocalizedString("TouchIdSettings.label", value:"Use your fingerprint to unlock your NixWallet and send money up to a set limit.", comment: "Touch Id screen label")
        static let switchLabel = NSLocalizedString("TouchIdSettings.switchLabel", value:"Enable Touch ID for NixWallet", comment: "Touch id switch label.")
    ...
    enum FaceIDSettings {
        ...
        static let label = NSLocalizedString("FaceIDSettings.label", value:"Use your face to unlock your NixWallet and send money up to a set limit.", comment: "Face ID screen label")
        static let switchLabel = NSLocalizedString("FaceIDSettings.switchLabel", value:"Enable Face ID for NixWallet", comment: "Face id switch label.")
    ...
    enum Settings {
        ...
        static let enjoying = NSLocalizedString("Settings.enjoying", value: "Are you enjoying NixWallet?", comment: "Are you enjoying NixWallet alert message body")
    ...
    enum About {
        ...
        static let footer = NSLocalizedString("About.footer", value:"Made by the global Nix Platform team.\n %1$@", comment: "About screen footer")
    }
    ...
    enum PushNotifications {
        ...
        static let body = NSLocalizedString("PushNotifications.body", value:"Turn on notifications to receive special messages from NixWallet in the future.", comment: "Push notifications settings view body")
    ...
    enum DefaultCurrency {
        ...
        static let bitcoinLabel = NSLocalizedString("DefaultCurrency.bitcoinLabel", value: "NIX Display Unit", comment: "NIX denomination picker label")
    }
    ...
    enum ReScan {
        ...
        static let body2 = NSLocalizedString("ReScan.body2", value:"If a transaction shows as completed on the NIX network but not in your NixWallet.", comment: "Syncing explanation")
    ...
    enum ShareData {
        ...
        static let body = NSLocalizedString("ShareData.body", value:"Help improve NixWallet by sharing your anonymous data with us. This does not include any financial information. We respect your financial privacy.", comment: "Share data view body")
    ...
    enum StartPaperPhrase {
        static let body = NSLocalizedString("StartPaperPhrase.body", value:"Your paper key is the only way to restore your NixWallet if your phone is lost, stolen, broken, or upgraded.\n\nWe will show you a list of words to write down on a piece of paper and keep safe.", comment: "Paper key explanation text.")
    ...
    enum RequestAnAmount {
        static let title = NSLocalizedString("RequestAnAmount.title", value:"Request an Amount", comment: "Request a specific amount of NIX")
    ...
    enum MenuButton {
        ...
        static let buy = NSLocalizedString("MenuButton.buy", value:"Buy NIX", comment: "Buy NIX title")
    }
    ...
    enum StartViewController {
        ...
        static let message = NSLocalizedString("StartViewController.message", value: "The most secure and safest way to use NIX on the go.", comment: "Start view message")
    }
    ...
    enum Watch {
        static let noWalletWarning = NSLocalizedString("Watch.noWalletWarning", value: "Open the NixWallet iPhone app to set up your wallet.", comment: "'No wallet' warning for watch app")
    }
    ...
    enum Prompts {
        ...
        enum UpgradePin {
            ...
            static let body = NSLocalizedString("Prompts.UpgradePin.body", value: "NixWallet has upgraded to using a 6-digit PIN. Tap here to upgrade.", comment: "Upgrade PIN prompt body.")
        }
        ...
        enum ShareData {
            ...
            static let body = NSLocalizedString("Prompts.ShareData.body", value: "Help improve NixWallet by sharing your anonymous data with us", comment: "Share data prompt body")
        }
        enum FaceId {
    ...
    enum PaymentProtocol {
        enum Errors {
            ...
            static let smallPayment = NSLocalizedString("PaymentProtocol.Errors.smallPayment", value: "NIX payments can't be less than %1$@.", comment: "Amount too small error message")
            static let smallTransaction = NSLocalizedString("PaymentProtocol.Errors.smallTransaction", value: "NIX transaction outputs can't be less than $@.", comment: "Output too small error message.")
    ...
    enum LocationPlugin {
        ...
        static let notAuthorized = NSLocalizedString("LocationPlugin.notAuthorized", value: "NixWallet does not have permission to access location services.", comment: "No permissions for location services")
    }
    ...
    enum Import {
        ...
        static let rightCaption = NSLocalizedString("Import.rightCaption", value: "Your NixWallet Wallet", comment: "Caption for graphics")
        static let importMessage = NSLocalizedString("Import.message", value: "Importing a wallet transfers all the money from your other wallet into your NixWallet wallet using a single transaction.", comment: "Import wallet intro screen message")
        ...
        static let confirm = NSLocalizedString("Import.confirm", value: "Send %1$@ from this private key into your wallet? The NIX network will receive a fee of %2$@.", comment: "Sweep private key confirmation message")
    ...
    enum BitID {
        ...
        static let authenticationRequest = NSLocalizedString("BitID.authenticationRequest", value: "%1$@ is requesting authentication using your NIX wallet", comment: "<sitename> is requesting authentication using your NIX wallet")
    ...
    enum WipeWallet {
        ...
        static let startMessage = NSLocalizedString("WipeWallet.startMessage", value: "Starting or recovering another wallet allows you to access and manage a different NixWallet wallet on this device.", comment: "Start wipe wallet view message")
    ...
    enum NodeSelector {
        ...
        static let title = NSLocalizedString("NodeSelector.title", value: "NIX Nodes", comment: "Node Selector view title")
