...
class Sender {
    ...
    private func postProtocolPaymentIfNeeded() {
        ...
        request.setValue("application/nix-payment", forHTTPHeaderField: "Content-Type")
        request.addValue("application/nix-paymentack", forHTTPHeaderField: "Accept")
        ...
        URLSession.shared.dataTask(with: request as URLRequest) { data, response, error in
            ...
            if response.mimeType == "application/nix-paymentack" && data.count <= 50000 {
